...
- It needs to scale
- It needs to be available to teams to use the data
- It needs to be cost effective (more on that later)
- It needs to be accurate (Its finance data afterall)

## Infrastructure
![infrastructure](./assets/v2_infrastructure.png "cloud infrastructure")


## How the partitions work
With AWS Athena (and other databases, eg Snowflake) data is stored in micro partitions, where you can structure the data into logical partitions to reduce the query load. This reduces compute costs substantially. The partitions used for this database are accountnumber, year, month and day. 
